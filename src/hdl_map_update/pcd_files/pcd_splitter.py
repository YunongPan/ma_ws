...
if __name__ == '__main__':
    ...
    #                original_header =
                    ...
                    spiltted_pcd_file = open(path + "/gazebo_pcd_files/" + spiltted_pcd_file_txt, "w")
                ...
                if area_mat[-pos_y_area + max_y_area, pos_x_area - min_x_area] > 1:
                    ...
                    spiltted_pcd_file = open(path + "/gazebo_pcd_files/" + spiltted_pcd_file_txt, "a")
                    spiltted_pcd_file.write(line)
                    spiltted_pcd_file.close()
    ...
    splitted_pcd_files_path = path + "/gazebo_pcd_files/"
